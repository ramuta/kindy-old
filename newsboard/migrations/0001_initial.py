...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'News'
        db.create_table(u'newsboard_news', (
        ...
        db.send_create_signal(u'newsboard', ['News'])

        # Adding model 'NewsImage'
        db.create_table(u'newsboard_newsimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('news', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newsboard.News'])),
        ))
        db.send_create_signal(u'newsboard', ['NewsImage'])

        # Adding model 'NewsFile'
        db.create_table(u'newsboard_newsfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'newsboard', ['NewsFile'])


    def backwards(self, orm):
        # Deleting model 'News'
        db.delete_table(u'newsboard_news')

        # Deleting model 'NewsImage'
        db.delete_table(u'newsboard_newsimage')

        # Deleting model 'NewsFile'
        db.delete_table(u'newsboard_newsfile')
