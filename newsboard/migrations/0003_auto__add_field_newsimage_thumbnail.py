...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsImage.thumbnail'
        db.add_column(u'newsboard_newsimage', 'thumbnail',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsImage.thumbnail'
        db.delete_column(u'newsboard_newsimage', 'thumbnail')
